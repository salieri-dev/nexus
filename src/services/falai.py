...
class FalAI:
    ...
    def __new__(cls):
        if cls._instance is None:
            cls._instance = super(FalAI, cls).__new__(cls)
    ...
    async def transcribe_audio(self, file_path: str, language: str = "ru") -> Dict[str, Any]:
        """
    ...
    async def generate_image(self, model_name: str, payload: Dict[str, Any]) -> AsyncGenerator[Dict[str, Any], None]:
        """
    ...
    async def generate_image_sync(self, model_name: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def upscale_image(self, image_path: str, upscale_factor: int = 2) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            url = await self.upload_file(image_path)
