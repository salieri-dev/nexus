...
async def initialize():
    ...
    try:
        ...
        default_config = {"DEATHBYAI_SYSTEM_PROMPT": system_prompt, "DEATHBYAI_MODEL_NAME": "anthropic/claude-3.5-sonnet:beta", "DEATHBYAI_GAME_DURATION_MINUTES": 1, "DEATHBYAI_EVALUATION_TEMPERATURE": 0.7}
