    ...
    try:
        ...
        models = [
            {   
                ...
                "civitai_id": 827184,
                "name": "Модель аниме",
                "url": "https://civitai.com/api/download/models/1410435?type=Model&format=SafeTensor&size=pruned&fp=fp16",
                "description": "NSFW model from Civitai"
            },
            {
                "id": "real_dream",
                "civitai_id": 153568,
                "name": "Модель с уклоном в фотореализм",
                "url": "https://civitai.com/api/download/models/1376263?type=Model&format=SafeTensor&size=pruned&fp=fp16",
                "description": "Realistic model from Civitai"
            }
        ]
        ...
        loras = [
            {
                "id": "dungeon_squad_style",
                "civitai_id": 486237,
                "name": "Dungeon Squad Style",
                "url": "https://civitai.com/api/download/models/1399376?type=Model&format=SafeTensor",
                "description": "Dungeon style lora from Civitai",
                "default_scale": 1.0,
