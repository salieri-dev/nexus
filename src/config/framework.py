...
class PeerConfigModel(BaseModel):
    ...
    nsfw_enabled: bool = Field(
        default=False,
        description="Filter NSFW content in this chat",
    ...
    @classmethod
    def register_param(cls, param_name: str, param_type: str,
                      default: Any, description: str, display_name: str,
        ...
        cls.param_registry[param_name] = ConfigParam(
            default=default,
...
async def get_chat_setting(chat_id: int, param_name: str, default=None):
    ...
    try:
        ...
        logger.error("Error getting chat setting",
                    error=str(e),
                    chat_id=chat_id,
                    setting=param_name)
        return default
...
async def update_chat_setting(chat_id: int, param_name: str, value: Any):
    ...
    try:
        ...
        logger.error("Error updating chat setting",
                    error=str(e),
                    chat_id=chat_id,
                    setting=param_name,
                    value=value)
